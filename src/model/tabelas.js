...
const Utilizador_Codigo = sequelize.define('utilizador_codigo', {
    codigo: {
        type: DataTypes.STRING,
        allowNull: false
    }
...
Tipos_pontos_interesse.hasMany(Utilizadores, {
    foreignKey: {
        name: 'id_tipo_ponto_interesse',
        allowNull: false
    }
})
Utilizadores.belongsTo(Tipos_pontos_interesse, {
    foreignKey: {
        name: 'id_tipo_ponto_interesse',
        allowNull: false
    }
...
Utilizadores.hasOne(Utilizador_Codigo, {
    foreignKey: {
        name: 'id_utilizador',
        allowNull: false
    }
})
Utilizador_Codigo.belongsTo(Utilizadores, {
    foreignKey: {
        name: 'id_utilizador',
        allowNull: false
    }
...
Utilizador_Role.hasMany(Utilizadores, {
    foreignKey: {
        name: 'id_role',
        allowNull: false
    }
})
Utilizadores.belongsTo(Utilizador_Role, {
    foreignKey: {
        name: 'id_role',
        allowNull: false
    }
